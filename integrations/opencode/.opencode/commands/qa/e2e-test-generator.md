---
description: Run the `e2e-test-generator` QA workflow against the current task
---

Read `qa-skills-plugin/skills/e2e-test-generator/SKILL.md` from the current repository.

Follow its deterministic execution flow exactly.
Load only the references you need from `qa-skills-plugin/skills/e2e-test-generator/references/`.
