---
description: Run the `risk-analyzer` QA workflow against the current task
---

Read `qa-skills-plugin/skills/risk-analyzer/SKILL.md` from the current repository.

Follow its deterministic execution flow exactly.
Load only the references you need from `qa-skills-plugin/skills/risk-analyzer/references/`.
